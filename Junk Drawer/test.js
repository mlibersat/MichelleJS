...
//     const ggbDiv = allCanvases[i].closest("div.appletParameters,div.notranslate");
//     if (ggbDiv) {
//       const parameterID = ggbDiv.getAttribute("id");
//       const canvasID = "canvas" + parameterID;
//       allCanvases[i].setAttribute("id", canvasID);
//       const parameterRole = ggbDiv.querySelectorAll('[role="application"]');
//       if (parameterRole) {
...
//   const unavailableButtonText = "This button is unavailable.";
...
//   const enableOrDisable = boolean ? "enable" : "disable";
