function ggbOnInit(name, ggbObject) {
  loadUtils().then(function (setupGGB) {
    ...
    setAriaLabel(ggbcanvas, "Coordinate Interactive");
    ...
    var pic = document.getElementById(ggbcanvas);
    if (pic) {
      console.log("doc.getEl");
      // pic.setAttribute("aria-label", arialabel);
      el.style.borderColor = el.style.borderColor == "yellow" ? "inherit" : "yellow";
    }
    ...
    // <a href="example.html" onfocus="toggleFocus(pic2)" onblur="toggleFocus(pic2)">
    //   focus me
    // </a>;
