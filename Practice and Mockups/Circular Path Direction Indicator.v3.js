...
function ggbOnInit(name, ggbObject) {  
  ...
  //the guideRadius is based on a 1:1 window setting. If applet uses other window settings, change "16xpixel" below to a comperable value.
