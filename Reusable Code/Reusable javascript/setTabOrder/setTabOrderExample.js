...
/* 
      ...
      */
// let initList = "Point1, Point2, Point3"; // A list of all things on "stage" when applet initializes. One string, separated by commas. No need to add status name, instructionIcon or xIcon. Those are added in the library.
// let addedList = ""; // A list of all items added since the first initialization (e.g., objects created onthe fly). One string, separated by commas.
// let enders = "ggbButton1"; // A list of all items that need to be at the end of the tabOrder list. One string, separated by commas.
...
let initList = "A,B,C,D,E"; // A list of all things you want in the tabOrder when the applet initializes. One string, separated by commas. No need to add status name, instructionIcon or xIcon. Those are added in the library.
let addedList = ""; // A list of all items added since the first initialization (e.g., objects created onthe fly). One string, separated by commas.
let enders = "ggbButton1"; // A list of all items that need to be at the end of the tabOrder list. One string, separated by commas.
