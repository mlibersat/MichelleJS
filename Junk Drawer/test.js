...
*/
    ...
    function enableDisableButton() {
      ...
      if (toolNum === 1) {
        Length = pointsArray.length;
        var enableBool = Length > 1 ? true : false;
    ...
    function manageToolChange() {
      ...
      // When the tool is changed away from create polys, delete any stray points that may have been created and not made into a poly.
      if (toolNum !== 1) {
